...
# Fix the create.html file
cat > templates/paper_options/create.html << 'CREATEHTML'
{% extends "layout.html" %}

{% block title %}Add Paper Option - Print Order Management System{% endblock %}

{% block page_header %}
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0">Add Paper Option</h1>
...
<div class="card">
    <div class="card-body">
        <form action="{{ url_for('paper_options_create') }}" method="post">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="weight" id="weight" class="form-control" placeholder="e.g., 20#, 80#, 100#">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="color" id="color" class="form-control" placeholder="e.g., White, Cream, Blue">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" name="width" id="width" class="form-control" step="0.125" min="0" placeholder="e.g., 8.5">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="height" id="height" class="form-control" step="0.125" min="0" placeholder="e.g., 11">
                    <div class="form-text">For custom sizes or square footage calculations</div>
                </div>
            </div>
            ...
            <div class="row mb-3 per-sheet-pricing">
                <div class="col-md-6">
                    <label for="price_per_sheet" class="form-label">Price per Sheet (Retail) *</label>
                    <div class="input-group">
                        <span class="input-group-text">$</span>
                        <input type="number" name="price_per_sheet" id="price_per_sheet" class="form-control" step="0.01" min="0" value="0.00" required>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">$</span>
                        <input type="number" name="cost_per_sheet" id="cost_per_sheet" class="form-control" step="0.01" min="0" value="0.00">
                    </div>
            ...
            <div class="text-end">
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-save me-1"></i> Save Paper Option
                </button>
            </div>
...
# Now check and fix edit.html if needed
grep -c 'roll-specific-fields' templates/paper_options/edit.html
if [ $? -gt 2 ]; then
    cat > templates/paper_options/edit.html << 'EDITHTML'
{% extends "layout.html" %}
