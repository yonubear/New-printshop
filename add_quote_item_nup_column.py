#!/usr/bin/env python3
"""
Add N-up Column to Quote Item Table

This script adds the missing n_up column to the quote_item table in the PostgreSQL database.
This column is required for the n-up printing feature to work properly with quotes.
...
def main():
    ...
    logger.info("Starting quote_item table fixes...")
