#!/usr/bin/env python3
"""
Script to add square footage pricing columns to the PostgreSQL database.
This adds price_per_sqft, cost_per_sqft, and pricing_method columns to the paper_option table,
...
def add_sqft_pricing_columns():
    ...
    try:
        ...
        cursor.execute("""
            ...
            WHERE table_name='paper_option' AND column_name IN ('price_per_sqft', 'cost_per_sqft', 'pricing_method');
        """)
        ...
        # Commit the changes
        conn.commit()
        print("Successfully added square footage pricing columns to the database!")
